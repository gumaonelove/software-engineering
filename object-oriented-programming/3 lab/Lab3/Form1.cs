...
namespace Lab2
{
    public partial class Form1 : Form
    {
        ...
        {
            Form f_poly = new Form_polygon(this);
            f_poly.Show();
        }

        private void Btn_triangle_Click(object sender, EventArgs e)
        {
            Form f_tri = new Form_triangle(this);
            f_tri.Show();
        }
        private void Btn_human_Click(object sender, EventArgs e)
        {
            Form f_human = new Form_human(this);
            f_human.Show();
        }
